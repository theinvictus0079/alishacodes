    ...
    >
      <nav className="mt-2 border bg-[#fffefe] bg-opacity-95 border-neutral-300 rounded-3xl container mx-auto px-6 py-2 md:py-2">
        <div className="flex items-center justify-between">
          <div className="text-2xl font-bold bg-gradient-to-r from-stone-700 to-red-500 bg-clip-text text-transparent  ">
            {name}
          </div>
          ...
          <a href="https://buymeacoffee.com/thecoderboy11" target="__blank">
            <div
              className="hidden md:flex justify-center items-center gap-x-1 font-bold border border-yellow-500 hover:bg-white bg-yellow-400 text-lg rounded-3xl py-1 px-3
            ...
            >
              <div>
                <img
                  ...
                  src={buymecoffee}
                  alt="support button logo"
                />
              </div>
              <div className="pr-4">Support</div>
            </div>
          </a>
        ...
        >
          <div className="pt-4 pb-3 space-y-3 ">
            ...
            <a
              className=""
              href="https://buymeacoffee.com/thecoderboy11"
              target="__blank"
            >
              <div
                className="mt-5 flex justify-center items-center gap-x-1 font-bold border border-yellow-500  bg-yellow-400 text-lg rounded-3xl py-2 px-6
